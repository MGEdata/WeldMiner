...
class TableMiningAgent(Chain):
    ...
    def _call(
        ...
        if table_type == "Crystal":
        ...
        elif table_type in ["Property", "Welding Process", "Mixed"]:
            # The shared extractor supports welding_process and measured properties.
            # Preserve the semantic category while extracting a mixed table intact.
            ...
            raise ContextError("Must be one of [Crystal, Bond & Angle, Coordinate, Property, Welding Process, Mixed, Elemental Composition]")
